...
void CAI_NetworkManager::LoadNetworkGraph( void )
{
	...
	if ( mapversion != gpGlobals->mapversion && !g_ai_norebuildgraph.GetBool() )
	{
		...
		if (!V_stricmp(szLoweredGameDir, "hl2") || !V_stricmp(szLoweredGameDir, "episodic") || !V_stricmp(szLoweredGameDir, "smod3_hl2") || !V_stricmp(szLoweredGameDir, "smod3_ep1"))
		{
			bOK = true;
		}
...
bool CAI_NetworkManager::IsAIFileCurrent ( const char *szMapName )
{
	...
	
	{
		...
		//DAMMIT i forgot to add in ty's build.
		if (!V_stricmp(szLoweredGameDir, "hl2") || !V_stricmp(szLoweredGameDir, "episodic") || !V_stricmp(szLoweredGameDir, "ep2") || !V_stricmp(szLoweredGameDir, "portal") || !V_stricmp(szLoweredGameDir, "lostcoast") || !V_stricmp(szLoweredGameDir, "hl1") || !V_stricmp(szLoweredGameDir, "smod3_hl2") || !V_stricmp(szLoweredGameDir, "smod3_ep1") || !V_stricmp(szLoweredGameDir, "smod3_ep2") || !V_stricmp(szLoweredGameDir, "smod3_eclipson_ty"))
		{
