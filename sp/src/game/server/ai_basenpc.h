...
enum AI_Gore_HeadshotModes
{
	HEADSHOT_DECAPITATION,
	HEADSHOT_DISMEMBERMENT,
};
...
public:
	...
	virtual bool		ShouldHeadshot(const CTakeDamageInfo &info);	// Always ragdoll, unless specified by the leaf class
	virtual bool		Event_Gibbed( const CTakeDamageInfo &info );
	virtual void		Event_Killed( const CTakeDamageInfo &info );
	virtual void		HeadshotEffect(const CTakeDamageInfo &info, int headshotMode);
	virtual void		GoreEffect(const CTakeDamageInfo &info);
	virtual int			GetHeadshotDamageType(const CTakeDamageInfo &info);
	// currently this system is only for humanoids, so we set this to false.
	virtual bool				CanUseNewGoreSystem(void) { return false; }
	virtual bool				CanHeadshot(void) { return false; }
	virtual const char*			GetGibName_Head(void) { return ""; }
	virtual const char*			GetGibName_Torso(void) { return ""; }
	virtual const char*			GetGibName_Pelvis(void) { return ""; }
	virtual const char*			GetGibName_Arm_L(void) { return ""; }
	virtual const char*			GetGibName_Arm_R(void) { return ""; }
	virtual const char*			GetGibName_Leg_L(void) { return ""; }
	virtual const char*			GetGibName_Leg_R(void) { return ""; }
	virtual const char*			GetGibName_Beheaded(void) { return ""; }
