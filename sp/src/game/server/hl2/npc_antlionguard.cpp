...
public:
	...
	virtual bool	BecomeRagdoll(CTakeDamageInfo info, const Vector &force);
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuard::BecomeRagdoll(CTakeDamageInfo info, const Vector &force)
{
	...
	newinfo.SetDamageForce(force);
	newinfo.SetDamagePosition(WorldSpaceCenter());

	return BaseClass::BecomeRagdoll(info, force );
}
