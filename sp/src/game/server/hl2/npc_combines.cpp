...
void CNPC_CombineS::Precache()
{
	...
	{
		m_fIsPrisonGuard = true;
	}
	else
	{
		m_fIsPrisonGuard = false;
	}
...
const char*	CNPC_CombineS::GetGibName_Head(void) 
{ 
	if (IsElite())
	{
		return "models/gibs/soldier_elite_head.mdl";
	}
	else if (IsPrisonGuard() && HasShotgun())
	{
		return "models/gibs/soldier_shotgun_prisonguard_head.mdl";
	}
	else if (HasShotgun())
	{
...
const char*	CNPC_CombineS::GetGibName_Torso(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Pelvis(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Arm_L(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Arm_R(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Leg_L(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Leg_R(void) 
{ 
	if (IsElite())
	{
...
const char*	CNPC_CombineS::GetGibName_Beheaded(void) 
{ 
	if (IsElite())
	{
