...
public:
	...
	bool	CanUseNewGoreSystem(void) { return true; }
	bool	CanHeadshot(void) { return true; }
	const char*			GetGibName_Head(void) { return "models/gibs/police_head.mdl"; }
	const char*			GetGibName_Torso(void) { return "models/gibs/police_torso.mdl"; }
	const char*			GetGibName_Pelvis(void) { return "models/gibs/police_pelvis.mdl"; }
	const char*			GetGibName_Arm_L(void) { return "models/gibs/police_left_arm.mdl"; }
	const char*			GetGibName_Arm_R(void) { return "models/gibs/police_right_arm.mdl"; }
	const char*			GetGibName_Leg_L(void) { return "models/gibs/police_right_leg.mdl"; }
	const char*			GetGibName_Leg_R(void) { return "models/gibs/police_right_leg.mdl"; }
	const char*			GetGibName_Beheaded(void) { return "models/gibs/police_beheaded.mdl"; }
