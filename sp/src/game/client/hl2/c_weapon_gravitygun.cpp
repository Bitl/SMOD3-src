...
CLIENTEFFECT_MATERIAL( "sprites/physbeam" )      //наш любимый лучик у physgun
...
public:
	...
	int KeyInput(int down, ButtonCode_t keynum, const char *pszCurrentBinding)
	{
		...
		// разрешаем движку начать процесс
...
// ммм...здесь вроде была главная ошибка!Теперь не будет.=))
private:
