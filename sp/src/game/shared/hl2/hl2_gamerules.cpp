...
ConVar	sk_max_striderbuster	( "sk_max_striderbuster", "0", FCVAR_REPLICATED);
...
ConVar	sk_max_cguard("sk_max_cguard", "0", FCVAR_REPLICATED);
ConVar  sk_plr_dmg_shovel_swing("sk_plr_dmg_shovel_swing", "0");
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER,			CLASS_HACKED_ROLLERMINE,D_NU, 0);
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("FlareRound",		DMG_BULLET | DMG_BURN,		TRACER_NONE,			"sk_plr_dmg_flare",		"sk_npc_dmg_flare",		"sk_max_flare",	0, 0);
		def.AddAmmoType("CGuard",			DMG_DISSOLVE,				TRACER_NONE,			0,						0,						"sk_max_cguard", 0, 0);
		def.AddAmmoType("CombineHeavyCannon",	DMG_BULLET,				TRACER_LINE,			40,	40, NULL, 10 * 750 * 12, AMMO_FORCE_DROP_IF_CARRIED ); // hit like a 10 kg weight at 750 ft/s
		def.AddAmmoType("ammo_proto1",			DMG_BULLET,				TRACER_LINE,			0, 0, 10, 0, 0 );
		def.AddAmmoType("ammo_shovel", DMG_BULLET | DMG_SLASH, TRACER_NONE, "sk_plr_dmg_shovel_swing", 5, 1, BULLET_IMPULSE(400, 1200), 0);
	}
